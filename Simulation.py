...
evo.create_creature(world = map.world, number=2) #create 50 creatures
...
ani = FuncAnimation(fig, map.update_map, frames = 100, interval = 10000, blit = True) #for animation of graph
plt.show()
